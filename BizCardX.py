...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Abhilash G",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Abhilash G*!"""})
...
mydb = mysql.connector.connect(
        host = "mysql-167159-0.cloudclusters.net",
		    port = "19987",
        user = "admin",
        password = "q4yaCFGr",
        database = "Bizcard")
